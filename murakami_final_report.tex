...
\begin{tabular}[t]{|l|}
\hline
救助中ヘリから落下、心肺停止の１人を翌日発見 \\ \hline
石破氏なお秘密報道に疑問 「処罰対象ではないが…」 \\ \hline
レーシック手術の被害情報5年で80件、目の痛みや矯正のしすぎ／消費者庁 \\ \hline
秘密法案、与党が夜にも成立強行 会期２日延長、攻防は最終局面 \\ \hline
人類最古のＤＮＡ抽出…４０万年前の人骨から \\ \hline
「ふなっしー」酷似「きゃべっしー」に苦情殺到 \\ \hline
甘利氏が治療でＴＰＰ会合欠席へ 早期の舌がん、一時辞意も慰留 \\ \hline
自殺原因は過大なノルマ・罵声…日本郵便を提訴 \\ \hline
軽自動車保有税上げ 平均数千円、15年10月までに \\ \hline
米中会談は５時間半、防空圏「認めない」と副大統領、「日中ホットライン確立を」 \\ \hline
\end{tabular}
\end{center}
\end{table}

また、15人の協力者に実験に参加してもらい、人手によるTweetとニュース断片の関連度の評価やTweetとニュース断片のアラインメントのサンプルの収集を行った。

\def\kappac{$\kappa$係数}
人手による関連度評価やアラインメントの結果は、\kappac\cite{kappa}により評価した。\kappac は、人手によるクラス分類の際の、個人ごとによるずれを評価する尺度である。\kappac は以下の式によって定義される。
